...
<head>
    ...
    <style>
        ...
        .badge.avocat {
            background: var(--avocat-color);
            color: var(--avocat-text);
        }

        .badge.huissier {
            background: var(--huissier-color);
            color: var(--huissier-text);
        }
...
<body>
    ...
    <div id="pagination" class="btn-pagination">

        <a href="roster&currentpage=<?= $Précidente ?>"><button <?= $currentePage == 1 ? "disabled" :"" ?> class=" pricidente">précident</button></a>



        <a href="roster&currentpage=<?= $Next ?>"><button <?= $total < 3 ||$NextCard == 0   ? "disabled" :"" ?> class="suivante">Suivant</button></a>
    </div>
